...
extension Color {
    ...
    public static let themeSteelGray = Color("SteelGray", bundle: Bundle.module)
...
//
    ...
    public static let themeDarkYellow = Color("DarkYellow", bundle: Bundle.module)
...
extension UIColor {
    ...
    public static let themeYellowY = UIColor(hex: 0xf5fa80)
    ...
    public static let themeSteelGray = UIColor(hex: 0xa4a9b7)
